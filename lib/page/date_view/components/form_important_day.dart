...
class FormImportantDayScreen extends StatefulWidget {
  ...
  const FormImportantDayScreen({super.key, required this.importantData});
...
class _FormImportantDayScreenState extends State<FormImportantDayScreen> {
  ...
  String buildDOBString() {
    ...
    String day = dayDobTEC.text.isEmpty
        ? '16'
        : formatWithLeadingZero(dayDobTEC.text);
  ...
  String buildWifeDOBString() {
    String day = dayWifeTEC.text.isEmpty
        ? '16'
        : formatWithLeadingZero(dayWifeTEC.text);
  ...
  List<String> lstGender = ['male', 'female'];
  int idxGender = 0;
  ...
  Future<void> fetchAuspiciousDate({
    ...
    final String baseUrl = 'https://apis-dev.xheroapp.com/auspicious-date/$aim';
  ...
  Future<void> getLunarDatetime(String date, String time) async {
    ...
    if (response.statusCode == 200) {
      try {
        ...
        EasyLoading.dismiss();
        setState(() {
          lunarDatetimeMajorData = lunarDateResponse.data;
  ...
  Future<void> getLunarDatetimeSecond(String date, String time) async {
    ...
    if (response.statusCode == 200) {
      try {
        ...
        EasyLoading.dismiss();
        setState(() {
          lunarDatetimeOthersData = lunarDateResponse.data;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Visibility(
                              visible: selectedValue?.code != 'tinh-trung-tang',
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [_infoTHIENArea(context)],
                              ),
                            ),
                            const SizedBox(height: 20),
                  ...
                  Flexible(
                    child: Text(
                      ...
                      style: selectedWork.isNotEmpty
                          ...
                          : TextAppStyle().hintTextGrey().copyWith(
                              fontSize: 14,
                            ),
                    ),
                  ),
    ...
    return onTapWidget(
      onTap: () async {
        ...
        if (selectedValue?.code == null) {
          PopupErrorState.show(
            context: context,
            title: 'pls_choose_thing_to_check'.tr,
          );
          setState(() {
        ...
        if (isIncludingDIA(widget.importantData.code ?? '') &&
          ...
          PopupErrorState.show(
            context: context,
            title: 'please_enter_dire_coor'.tr,
          );
          setState(() {
        ...
        try {
          fetchAuspiciousDate(
            ...
            deadTime: deathTimeSelected == ''
                ? '12:00:00'
                : '$deathTimeSelected:00',
      ...
      child: Center(
        child: Container(
          ...
          child: Center(
            child: Text('check_result'.tr, style: custom3DTextStyle(context)),
          ),
        ),
      ),
    );
                                  ...
                                  suffixIcon: onTapWidget(
                                    onTap: () async {
                                      ...
                                      if (value != '') {
                                        printConsole(value);
                                        onItemSelected(
                                          getCoorFromDegree(int.parse(value)) ??
                                              DireCoor(
                                                title: 'Tý',
                                                degree: '0\u00B0',
                                                code: 'ngo',
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Image.asset(
                                          getZodiacImage(
                                            getZodiacIndex(
                                              lunarDatetimeOthersData?.namChi ??
                                                  '',
                                            ),
                                          ),
                                          fit: BoxFit.contain,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        data['data']['warning']['tuoiMuon'] == null
                            ? const SizedBox()
                            : data['data']['warning']['tuoiMuon']['isXungTuoi'] ==
                                  true
                            ? Padding(
                                padding: const EdgeInsets.only(top: 16),
                                child: GradientText(
                        ...
                        Column(
                          children: List.generate(
                            data['data']['warning']['warningContent']['warningData']
                                    .length ??
                                0,
                            (idxWarningData) {
                              final warningDataItem =
                                  data['data']['warning']['warningContent']['warningData'][idxWarningData];
                              ...
                              return Container(
                                ...
                                child: Theme(
                                  ...
                                  child: ExpansionTile(
                                    ...
                                    collapsedIconColor: AppColor.colorRedBold,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            warningDataItem['kimlau'] == true
                                                ...
                                                : const SizedBox(),
                                            if (warningDataItem['hoangOc'] ==
                                                    true &&
                                                warningDataItem['kimlau'] ==
                                                    true)
                                              const SizedBox(height: 8),
                                            warningDataItem['hoangOc'] == true
                                                ? Text(
                                                ...
                                                : const SizedBox(),
                                            if (warningDataItem['tamTai'] ==
                                                true)
                                              const SizedBox(height: 8),
                                            warningDataItem['tamTai'] == true
                                                ? Text(
                                                    '• ${'tam_tai'.tr}',
                                                    style: TextAppStyle()
                                                        .normalTextStyleSmall()
                                                ...
                                                : const SizedBox(),
                                            if (warningDataItem['thaiTue'] ==
                                                true)
                                              if (warningDataItem['thaiTue'] ==
                                                  true)
                                                const SizedBox(height: 8),
                                            warningDataItem['thaiTue'] == true
                                                ? Text(
                                                    '• ${'thai_tue'.tr}',
                                                    style: TextAppStyle()
                                                        .normalTextStyle()
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    const SizedBox(height: 8),
                                    Column(
                                      children: List.generate(yearList.length, (
                                        idxYear,
                                      ) {
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          border: selectedIndex == index
                              ...
                              : Border.all(
                                  width: 1,
                                  color: AppColor.grayTextwhiteColor.withAlpha(
                                    (0.25 * 255).toInt(),
                                  ),
                                ),
                        ...
                        child: Text(
                          ...
                          style: selectedIndex == index
                              ? TextAppStyle().titleStyleLarge().copyWith(
                                  color: AppColor.actionTextYellow,
                                )
                              : TextAppStyle().normalTextStyle().copyWith(
