...
class _ResultOfImportantDayScreenState
                        ...
                        Positioned.fill(
                          child: Align(
                            ...
                            child: Container(
                              ...
                              margin: const EdgeInsets.only(top: 108, left: 0),
                                            ...
                                            Visibility(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    widget.dataResult['data']['timeDead']['time'] +
                                                        ':00' +
                                                        ' (' +
                                            ...
                                            Expanded(
                                              child: Row(
                                                children: List.generate(
                                                  widget
                                                      .dataResult['data']['dia']['hanhNgayChon']
                                                      .length,
                                                  (index) {
                                                    return Text(
                                                      (index + 1 ==
                                                ...
                                                ? Column(
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Text(
                                                          widget
                                                              .dataResult['data']['case1']['conclusion'],
                                                          style: TextAppStyle()
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    ...
                                                    checkDayMonthHours(
                                                      widget
                                                          .dataResult['data']['errShowDayMonthShowOneDate'],
                                                    ).tr,
                                                style: TextAppStyle()
                                                    .semiBoldTextStyle()
                                                    .copyWith(
                                                      ...
                                                      children: [
                                                        Column(
                                                          children: [
                                                            ...
                                                            Text(
                                                              widget.dataResult['data']?['arrDate']?[0]?['dateSolar'] ??
                                                                  '',
                                                              style: TextAppStyle()
                                                                  .thinTextStyleSmall(),
                                                            ),
                                                                ...
                                                                Text(
                                                                  ...
                                                                  style: TextAppStyle()
                                                                      ...
                                                                      .copyWith(
                                                                        color: getColorByElement(
                                                                          widget
                                                                              .dataResult['data']['arrDate'][0]['nguHanhNgay'],
                                                                        ),
                                                                      ),
                                                                ),
                                                              ],
                                                            ...
                                                            Text(
                                                              '${widget.dataResult['data']?['arrDate']?[0]?['canChiNgay'] ?? ''}'
                                                                      .tr +
                                                                  ' / ' +
                                                            ...
                                                            Wrap(
                                                              ...
                                                              children: List.generate(
                                                                widget
                                                                        .dataResult['data']?['arrDate']?[0]?['gio']
                                                                        ?.length ??
                                                                    0,
                                                                (idx) {
                                                                  final gioData =
                                                                      widget
                                                                          .dataResult['data']?['arrDate']?[0]?['gio']?[idx] ??
                                                                      {};
                                                                  return SizedBox(
                                                                    width:
                                                                        (getResponsiveWidth(
                                                          ...
                                                          child: onTapWidget(
                                                            onTap: () async {
                                                              ...
                                                              final query =
                                                                  ...
                                                                  >.from(
                                                                    widget
                                                                        .dataResult['data']['arrDate'][0],
                                                                  );
                                                              query['tuoiGiaChu'] =
                                                                  widget
                                                                      .dataResult['data']['tuoiGiaChu'];
                                                              query['type'] =
                                                                  widget.type;
                                                              if (widget
                                                                      .dataResult['data']?['dia']?['toaNha']?['key'] !=
                                                                  null) {
                                                                query['toa'] =
                                                                    widget
                                                                        .dataResult['data']!['dia']!['toaNha']!['key'];
        ...
        Container(
          ...
          child: RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(
                  text: '${widget.dataResult['data']['ngayThanTrung']['tuoi']}'
                      .tr,
                  style: TextAppStyle().normalTextStyleSmall(),
                ),
                TextSpan(
                ...
                TextSpan(
                  text:
                      '${widget.dataResult['data']['ngayThanTrung']['canNgayMat']}'
                          .tr +
                      ' ' +
        ...
        Container(
          ...
          child: RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(
                  text: '${widget.dataResult['data']['ngayTrungPhuc']['tuoi']}'
                      .tr,
                  style: TextAppStyle().normalTextStyleSmall(),
                ),
                TextSpan(
                ...
                TextSpan(
                  text:
                      '${widget.dataResult['data']['ngayTrungPhuc']['canNgayMat']}'
                          .tr +
                      ' ' +
        ...
        Row(
          children: [
            ...
            ColorFiltered(
              ...
              child: Image.asset(IconConstants.ic_male_avatar, width: 16),
            ),
            const SizedBox(width: 4),
            Text(
              'male'.tr,
        ...
        Row(
          children: [
            ...
            ColorFiltered(
              ...
              child: Image.asset(IconConstants.ic_female_avatar, width: 16),
            ),
            const SizedBox(width: 4),
            Text(
              'female'.tr,
  ...
  Future<void> _getHonoScopes({required String data}) async {
    final url = 'https://apis-dev.xheroapp.com/horoscopes?selectedData=$data';
    try {
  ...
  Widget resultWithTheOnlyDay() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('result'.tr + ':', style: TextAppStyle().titleStyle()),
        const SizedBox(height: 8),
        Container(
          decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors:
                    checkDayMonthHours(
                        ...
                        'phu_hop'
                    ? [AppColor.colorGreen, AppColor.colorGreenDark]
                    ...
                    child: Stack(
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'have_date_note'.tr,
                            style: TextAppStyle().thinTextStyleSmall().copyWith(
                              color: AppColor.primaryColor,
                            ),
                          ),
                        ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          widget
                                              .dataResult['data']['arrDate'][index]['dateSolar'],
                                          style: TextAppStyle()
                                              .normalTextStyle(),
                                        ),
                                      ],
                                    ...
                                    Row(
                                      children: List.generate(4, (i) {
                                        if (i <
                                            getStarCount(
                                              widget
                                                  .dataResult['data']['arrDate'][index]['textStatusDate'],
                                            )) {
                                            ...
                                            Column(
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      widget.dataResult['data']['arrDate'][index]['dateLunar'] +
                                                          ' - ',
                                                      style: TextAppStyle()
                                                          .thinTextStyleSmall(),
                                                    ),
                                                    ...
                                                    Text(
                                                      ...
                                                      style: TextAppStyle()
                                                          ...
                                                          .copyWith(
                                                            color: getColorByElement(
                                                              widget
                                                                  .dataResult['data']['arrDate'][index]['nguHanhNgay'],
                                                            ),
                                                          ),
                                                    ),
                                                  ],
                                                ...
                                                const SizedBox(height: 12),
                                                Text(
                                                  '${widget.dataResult['data']['arrDate'][index]['canChiNgay']}'
                                                          .tr +
                                                      ' / ' +
                                                ...
                                                Wrap(
                                                  ...
                                                  children: List.generate(
                                                    widget
                                                            .dataResult['data']['arrDate'][index]['gio']
                                                            .length ??
                                                        0,
                                                    (idx) {
                                                      return SizedBox(
                                                          ...
                                                          children: [
                                                            ClipOval(
                                                              child: SizedBox(
                                                                ...
                                                                child: Image.asset(
                                                                  getZodiacImage(
                                                                    (widget.dataResult['data']['arrDate'][index]['gio'][idx]['order'] ??
                                                                        0),
                                                                  ),
                                                                  fit: BoxFit
                                                                      .contain,
                                        ...
                                        child: onTapWidget(
                                          onTap: () async {
                                            ...
                                            final query = Map<String, dynamic>.from(
                                              widget
                                                  .dataResult['data']['arrDate'][index],
                                            );
                                            query['tuoiGiaChu'] = widget
                                                .dataResult['data']['tuoiGiaChu'];
            ...
            : Column(
                ...
                children: [
                  ...
                  if (widget.dataResult['data']['warningContentData'] != null &&
                      widget
                          .dataResult['data']['warningContentData']
                          .isNotEmpty)
                    WarningContentList(
                      warningContentData:
                          widget.dataResult['data']['warningContentData'],
                    ),
                  Text(
                    'select_another_day_note'.tr,
                    style: TextAppStyle().semiBoldTextStyleSmall().copyWith(
      ...
      itemBuilder: (context, index) {
        ...
        return Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              width: 0.25,
              color: isPham ? AppColor.colorRedBold : AppColor.colorGreenDark,
            ),
