...
//     widget.dayDobTEC
//         ?.addListener(() => _validateDay(widget.dayDobTEC!, (isValid) {
//               if (mounted) {
//                 setState(() {
//                   invalidDayDobTEC = !isValid;
//                   getAPIDOB =
//                       isValid && !invalidMonthDobTEC && !invalidYearDobTEC;
//                 });
//               }
//             }));

//     widget.monthDobTEC
//         ?.addListener(() => _validateMonth(widget.monthDobTEC!, (isValid) {
//               if (mounted) {
//                 setState(() {
//                   invalidMonthDobTEC = !isValid;
//                   getAPIDOB =
//                       isValid && !invalidDayDobTEC && !invalidYearDobTEC;
//                 });
//               }
//             }));

//     widget.yearDobTEC
//         .addListener(() => _validateYear(widget.yearDobTEC, (isValid) {
//               if (mounted) {
//                 setState(() {
//                   invalidYearDobTEC = !isValid;
//                   getAPIDOB =
//                       isValid && !invalidDayDobTEC && !invalidMonthDobTEC;
//                 });
//               }
//             }));
//   }
...
//         EasyLoading.dismiss();
//         setState(() {
//           lunarDatetimeData = response.data;
//           isShowDobNote = true;
//         });
//       } else {
//         EasyLoading.dismiss();
...
//                 border: Border(
//                     top:
//                         BorderSide(color: AppColor.actionTextYellow, width: 6)),
...
//                                       1; // Không cần .text ở đây
//                                   int day =
//                                       int.tryParse(widget.dayDobTEC!.text) ??
//                                           16;
